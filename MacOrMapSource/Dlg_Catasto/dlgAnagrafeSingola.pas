...
type
  TForm_AnagrafeSingola = class(TForm)
    PanLeft: TPanel;
    PanBottom: TPanel;
    PanTop: TPanel;
    PanRight: TPanel;
...
var
  Form_AnagrafeSingola: TForm_AnagrafeSingola;

implementation

{$R *.dfm}

uses Residente,famiglia,anagrafe;

procedure TForm_AnagrafeSingola.GrigliaDatiDrawCell(Sender: TObject; ACol,
...
procedure TForm_AnagrafeSingola.disegna;
var k : Integer;
    locfam : TFamiglia;
    locres : TResidente;
begin
   svuota;
    GrigliaDati.RowCount:= LaAnagrafe.listaResidentiFiltrata.count+1;
    for k:= 0 to LaAnagrafe.listaResidentiFiltrata.count-1 do
     begin
      locres := LaAnagrafe.listaResidentiFiltrata.items[k];
...
function  TForm_AnagrafeSingola.GetTitolo(colo : Integer) : String;
begin
 case colo of
  0 : result:='Cod';
  1 : result:='Cognome';
...
procedure  TForm_AnagrafeSingola.svuota;
var i : Integer;
begin
